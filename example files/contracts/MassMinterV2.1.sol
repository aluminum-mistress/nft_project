...
contract PublicMinter is ERC721, ERC721URIStorage, ERC2981, ERC165Storage, PaymentSplitter, Ownable {
 ...
 */
  ...
  function publicMint(string memory ipfsHash, uint256 permille) public payable {
    ...
    emit NewEpicNFTMinted(msg.sender, _tokenIdCounter.current());
  }
 ...
 */
  ...
  function sweepEthToAddress(address _user, uint256 _amount) public onlyOwner {
